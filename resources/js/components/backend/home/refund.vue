    ...
    <div>
        <div class="container-fluid">
            <div class="row p-3 bg-main rounded">
                <div class="col-md-12 rounded m-0 p-3"> 
                    <h4 class="color-white text-center fw-bold p-3 table-border-dark"><b-icon-wallet2 class="d-inline text-success mr-2" width="22" height="22"></b-icon-wallet2> Refund Policy</h4>

                    <div class="text-start">
                        <a @click="showAddeModal = true" class="my-3 btn btn-outline-light fw-bold table-border-dark shadow-sm"><b-icon-plus class="d-inline mr-1 text-primary" width="22" height="22"></b-icon-plus><span class="color-white">Add Refund Policy</span></a>
                    </div>
                        ...
                        <table class="table table-striped rounded color-white text-center">
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-2 my-auto">Action</th>
                            ...
                            <tbody>
                                ...
                                <tr class="mx-0 px-0 my-auto" v-for="(t,i) in privacy" :key="i">
                                    ...
                                    <td  class="mx-0 px-0 my-auto align-middle">
                                        <a @click="editModal(t,i)" class="mx-2 btn btn-sm btn-outline-primary px-2"><b-icon-pencil-square class="d-inline mr-1" width="16" height="16"></b-icon-pencil-square></a>
        ...
        <Modal
            ...
            <div class="row">
                ...
                <h5 class="p-3 table-border-dark mb-4 bg-header color-white text-center fw-bold"><b-icon-plus class="d-inline text-success mr-2" width="20" height="20"></b-icon-plus>Add Refund Policies</h5>
           
                <form class="row g-3 mx-auto" @submit.prevent="add" method="POST" @keydown="clearAllError">

                    <div class="col-md-12">
                        <label for="title" class="form-label fw-bolder color-white">Refund Title</label>
                    ...
                    <div class="col-md-12">
                        <label for="text" class="form-label fw-bolder color-white">Refund Description</label>
...
export default {
    data(){
        return{
            ...
            editorData: '<p>Content of Refund polices Page.</p>',
            // editorConfig: {
            //     ckfinder: {
    ...
    methods:{
        async add(){
            ...
            const res = await this.callApi("post","add/refund", this.data);
            if (res.status == 200) {
                this.successMsg("Refund Policy been Added successfully");
                this.getAll();
                this.data.text ='';
                this.data.title ='';
                this.editorData ='';
        ...
        async deleteData(){
            const res = await this.callApi("post","delete/refund", this.deleteItem);
            if (res.status == 200) {
        ...
        async update(){
            const res = await this.callApi("post","refund/update", this.editData);
            if (res.status == 200) {
        ...
        async getAll(page){
            const res = await this.callApi("get",`get/refund?total=${this.total}&page=${page}`);
            if (res.status == 200) {
