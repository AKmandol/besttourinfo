<template>
    <div class="bg-white">
        ...
        <div class="container-fluid main bg-dark mb-5 position-relative mt-50">
            ...
            <h1 class="display-4 text-success fw-bold text-center position-absolute top-50 start-50 translate-middle">Transction Successfull</h1>
        ...
        <Modal
            ...
            <div class="text-center p-3 bg-light rounded">
                ...
                <p class="text-dark text-sm">We Will Contact You Shortly.</p>
            </div>
...
.main {
    ...
    opacity: 0.8;
    background-image:  repeating-radial-gradient( circle at 0 0, transparent 0, #07380098 5px ), repeating-linear-gradient( #0000009f, #9242008e );
}
